...
# Game Players: Player Rock, Random Player
# Human Player, Reflective Player, Cycling Player
...
class HumanPlayer(Player):
    def move(self):
        ...
        while move not in moves:
            move = input("\033[97;1;24mWhat is your move? Rock, Paper, Scissors? --> \033[0m")
            return move
# subclass for a player that remembers and imitates
...
if __name__ == '__main__':
    ...
    # CyclePlayer(), HumanPlayer(), ReflectPlayer(), RandomPlayer())
    #game.play_game()
    game.play_round()
